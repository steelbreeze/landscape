 ...
 */
export declare function table<TRow extends Row>(cube: Cube<TRow>, axes: Axes<TRow>, getKey: Function<TRow, StyledPair>, onX: boolean, precise?: boolean): Array<Array<Cell>>;
/**
