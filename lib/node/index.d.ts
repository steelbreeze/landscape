 ...
 */
export declare function table<TRow extends Row>(cube: Cube<TRow>, axes: Axes<TRow>, getKey: Func1<TRow, Key<TRow>>, onX: boolean): Array<Array<Cell<TRow>>>;
/**
 ...
 * @param onX A flag to indicate if cells in cube containing multiple values should be split on the x axis (if not, the y axis will be used).
 */
export declare function split<TRow extends Row>(keys: Cube<Key<TRow>>, axes: Axes<TRow>, onX: boolean): Array<Array<Cell<TRow>>>;
/**
