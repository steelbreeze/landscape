...
exports.maxSplits = exports.merge = exports.split = exports.table = void 0;
/**
 ...
 */
exports.maxSplits = Number.MAX_SAFE_INTEGER;
/**
...
function leastCommonMultiple(source, callbackfn) {
    ...
    return Math.min(counts.reduce((a, b) => (a * b) / greatestCommonFactor(a, b)), Math.max(exports.maxSplits, ...counts));
}
/**
