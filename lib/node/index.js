...
exports.merge = exports.table = exports.criteria = void 0;
/**
 ...
 */
const table = (cube, y, x, getElement, onX, method = Math.max) => {
    ...
    const xSplits = x.map((_, iX) => onX ? method(...cells.map(row => row[iX].length)) : 1);
