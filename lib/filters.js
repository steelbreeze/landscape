...
function filterTarget(applications) {
    return applications.map(function (app) { return { detail: app.detail, usage: app.usage.filter(function (use) { return !use.decommissioned; }) }; }).filter(function (app) { return app.usage.length > 0; });
}
