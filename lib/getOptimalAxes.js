 ...
 */
function getOptimalAxes(applications, x, y, getKey, axesSelector = scenarios => scenarios[0], xF = flexOrder, yF = flexOrder) {
    ...
    const denormalised = applications.reduce((result, app) => {
        const interim = [];
