 ...
 */
function prepareData(applications, axes, key) {
    ...
    var _loop_1 = function (app) {
        var _loop_2 = function (use) {
            ...
            if (yIndex !== -1 && xIndex !== -1 && !result[yIndex][xIndex].some(function (da) { return da.detail[key] === app.detail[key] && da.status === use.status; })) {
